...
// Configuration
const CONFIG = {
  baseUrl: 'https://teamfueldenver.com/',
  ...
  rules: {
    ...
    '/careers/': { priority: '0.70', changefreq: 'monthly' },
    '/partners/': { priority: '0.70', changefreq: 'monthly' },
    '/faqs/': { priority: '0.70', changefreq: 'monthly' },
    '/blog/': { priority: '0.70', changefreq: 'weekly' },
    '/fleet-solutions/': { priority: '0.80', changefreq: 'monthly' },
    '/consumer-services/': { priority: '0.80', changefreq: 'monthly' },
